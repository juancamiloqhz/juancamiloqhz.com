...
export default function SomeThingsIveBuilt() {
  return (
    <div
      className="px-8 md:px-28 transition-all duration-500 ease-in-out mb-52 scroll-mt-40"
      id="work"
    >
      <div className="w-full max-w-5xl mx-auto">
        <div className="grid grid-cols-[1fr_auto] lg:gap-16">
          <div className="grid grid-cols-[auto_1fr] gap-4 items-center mb-14">
...
function FeaturedProject() {
  return (
    <div className="grid grid-cols-[60%_1fr] group">
      <div className="w-full h-fit relative justify-self-center lg:justify-self-auto">
        <Image
      ...
      <div className="z-[2] flex flex-col items-end justify-center">
        ...
        <div className="bg-neutral px-6 py-3 -ml-28 mt-4 rounded-[var(--rounded-btn)] shadow-md">
          <p className="my-3 text-right text-neutral-content">
        ...
        <p className="font-mono text-xs text-right mt-4 flex flex-wrap items-center gap-3 justify-end">
          <span>React</span>
          <span>NextJS</span>
        ...
        <div
          className="tooltip tooltip-left mt-2 hover:text-primary transition-all duration-300"
          data-tip="vibra.la"
        >

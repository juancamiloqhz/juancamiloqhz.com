          ...
          <div className="grid lg:grid-cols-[1fr_auto] gap-6 lg:gap-16">
            ...
            <div className="h-72 w-72 relative group mt-4 justify-self-center lg:justify-self-auto">
              <Image
                ...
                // width={176}
                fill
                className="object-cover object-center rounded-[var(--rounded-btn)] ring ring-primary ring-offset-8 ring-offset-base-100 transition-all duration-500 ease-in-out group-hover:ring-offset-0 group-hover:ring-offset-base-200"
                placeholder="blur"
                blurDataURL="data:image/png;base64,"
              />
              <div className="absolute rounded-[var(--rounded-btn)] top-0 bottom-0 left-0 right-0 bg-primary/40 group-hover:bg-transparent transition-all duration-500 ease-in-out" />
            </div>
          </div>
        </div>
      </motion.div>

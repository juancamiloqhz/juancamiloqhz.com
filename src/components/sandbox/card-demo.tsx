...
export function CardDemo() {
  return (
    <Card className="w-96 shadow-[2px_4px_16px_0px_rgba(248,248,248,0.06)_inset]">
      <CardSkeletonContainer>
        <Skeleton />
      </CardSkeletonContainer>
      <CardHeader>
        <CardTitle>The best AI models</CardTitle>
        <CardDescription>
          You'll use the best models and technologies to enhance your business.
        </CardDescription>
      </CardHeader>
    </Card>
  )
...
const Sparkles = () => {
  ...
  // Set mounted to true only after the component has mounted
  React.useEffect(() => {
    setMounted(true)
  }, [])
